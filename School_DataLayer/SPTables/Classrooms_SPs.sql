-- Stored Procedures for Table: Classrooms

Use [SchoolsDb];
Go


CREATE OR ALTER PROCEDURE SP_Get_Classrooms_ByID
(
    @ClassroomID int
)
AS
...
CREATE OR ALTER PROCEDURE SP_Get_All_Classrooms
AS
BEGIN
    BEGIN TRY
...
CREATE OR ALTER PROCEDURE SP_Add_Classrooms
(
...
CREATE OR ALTER PROCEDURE SP_Update_Classrooms_ByID
(
    @ClassroomID int,
    @ClassroomName varchar(50) = NULL,
    @Capacity int = NULL,
...
CREATE OR ALTER PROCEDURE SP_Delete_Classrooms_ByID
(
    @ClassroomID int
)
AS
...
CREATE OR ALTER PROCEDURE SP_Search_Classrooms_ByColumn
(
...
BEGIN
    BEGIN TRY
        ...
        WHEN 'ClassroomName' THEN 'ClassroomName'
        ...
        SET @SQL = N'SELECT * FROM ' + QUOTENAME('Classrooms') + 
