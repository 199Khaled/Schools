...
this.رسالة_الخطأ, this.الطابع_الزمني,this.تفاصيل_التتبع, this.شدة_الخطأ, this.معلومات_إضافية);
...
رسالة_الخطأ, الطابع_الزمني,تفاصيل_التتبع, شدة_الخطأ, معلومات_إضافية);
...
this.معرّف_الخطأ, this.رسالة_الخطأ, this.الطابع_الزمني, this.تفاصيل_التتبع, this.شدة_الخطأ, this.معلومات_إضافية);
       }
...
int? معرّف_الخطأ, string رسالة_الخطأ, DateTime? الطابع_الزمني, string تفاصيل_التتبع = null, string شدة_الخطأ = null, string معلومات_إضافية = null)        {
        return clsسجل_الأخطاءData.Updateسجل_الأخطاءByID(
معرّف_الخطأ, رسالة_الخطأ, الطابع_الزمني, تفاصيل_التتبع, شدة_الخطأ, معلومات_إضافية);
