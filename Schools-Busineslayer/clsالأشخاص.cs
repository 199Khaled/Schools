...
namespace SchoolsDb_BusinessLayer
{
    public class clsالأشخاص
    {
        ...
        public string الاسم_الكامل
        {
            get
            {
                if (string.IsNullOrWhiteSpace(اسم_الأب))
                    return $"{الاسم_الأول} {اسم_العائلة}";
                else
                    return $"{الاسم_الأول} {اسم_الأب} {اسم_العائلة}";
            }
        }
        ...
        private clsالأشخاص(int? معرّف_الشخص, string الاسم_الأول, string اسم_العائلة,
            DateTime? تاريخ_الميلاد, string اسم_الأب = null, string اسم_الأم = null,
        ...
        public static bool AddNewالأشخاص(ref int? معرّف_الشخص, string الاسم_الأول, string اسم_العائلة,
            DateTime? تاريخ_الميلاد, string اسم_الأب = null, string اسم_الأم = null,
            string الجنس = null, string المدينة = null, string الهاتف = null, string البريد_الإلكتروني = null)
        {
            معرّف_الشخص = clsالأشخاصData.AddNewالأشخاص(
                الاسم_الأول, اسم_العائلة, تاريخ_الميلاد, اسم_الأب, اسم_الأم,
                الجنس, المدينة, الهاتف, البريد_الإلكتروني);
        ...
        private bool _Updateالأشخاص()
        {
            return clsالأشخاصData.UpdateالأشخاصByID(
                this.معرّف_الشخص, this.الاسم_الأول, this.اسم_العائلة,this.تاريخ_الميلاد, this.اسم_الأب, this.اسم_الأم
               , this.الجنس, this.المدينة, this.الهاتف, this.البريد_الإلكتروني);
        }

        public static bool UpdateالأشخاصByID(int? معرّف_الشخص, string الاسم_الأول, string اسم_العائلة,
            DateTime? تاريخ_الميلاد, string اسم_الأب = null, string اسم_الأم = null,
            string الجنس = null, string المدينة = null, string الهاتف = null, string البريد_الإلكتروني = null)
        {
            return clsالأشخاصData.UpdateالأشخاصByID(
                معرّف_الشخص, الاسم_الأول, اسم_العائلة, تاريخ_الميلاد, اسم_الأب, اسم_الأم
                , الجنس, المدينة, الهاتف, البريد_الإلكتروني);
        }
        ...
        public static clsالأشخاص FindByمعرّف_الشخص(int? معرّف_الشخص)
        {
            ...
            string الاسم_الأول = "", اسم_الأب = "", اسم_الأم = "", اسم_العائلة = "";
            DateTime? تاريخ_الميلاد = DateTime.Now;
            string الجنس = "", المدينة = "", الهاتف = "", البريد_الإلكتروني = "";

            bool IsFound = clsالأشخاصData.GetالأشخاصInfoByID(معرّف_الشخص,
                ref الاسم_الأول, ref اسم_الأب, ref اسم_الأم, ref اسم_العائلة,
                ref تاريخ_الميلاد, ref الجنس, ref المدينة, ref الهاتف, ref البريد_الإلكتروني);

            if (IsFound)
                return new clsالأشخاص(معرّف_الشخص, الاسم_الأول, اسم_العائلة, تاريخ_الميلاد,
                    اسم_الأب, اسم_الأم, الجنس, المدينة, الهاتف, البريد_الإلكتروني);
            else
                return null;
        }
